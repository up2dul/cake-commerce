...
const fieldVariants = cva(
	"data-[invalid=true]:text-destructive gap-0.5 group/field flex w-full",
	{
		variants: {
			orientation: {
...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: unnecessary at all
		<div
			role="group"
			data-slot="field"
	...
	return (
		<Label
			...
			className={cn(
				...
				"font-semibold text-raisin-black/70 text-xs/4",
				className,
			)}
			{...props}
		/>
...
function FieldDescription({
	...
	return (
		<div
			...
			className={cn(
				"text-foreground text-left text-sm/5 [[data-variant=legend]+&]:-mt-1.5 leading-normal font-medium group-has-data-[orientation=horizontal]/field:text-balance",
